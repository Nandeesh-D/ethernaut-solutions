...
/**Once our new king contract becomes the owner there are no fallback or recienve function implememted to recieve the ether it reverts all the time after we become the new king */
contract NewKing{
...
contract Level9Solution is Script{
    ...
    function run() external{
        ...
        address(level9).call{value:prize}("");  //calling recieve function in king contract
        vm.stopBroadcast();
    }
}